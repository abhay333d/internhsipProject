...
function setup_lighting(three) {
  ...
  new THREE.RGBELoader()
    ...
    .load("assets/rogland_clear_night_1k.hdr", function (texture) {
...
function add_softOccluder() {
  ...
  const dr =
    _settings.occluderRadiusRange[1] - _settings.occluderRadiusRange[0];
